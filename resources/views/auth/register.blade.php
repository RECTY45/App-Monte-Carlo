                    ...
                    <div class="card-body">
                        ...
                        <div class="app-brand justify-content-center">
                            <a href="index.html" class="app-brand-link gap-2">
                                            ...
                                            <g id="Brand-Logo" transform="translate(-27.000000, -15.000000)">
                                                <g id="Icon" transform="translate(27.000000, 15.000000)">
                                                    <g id="Mask" transform="translate(0.000000, 8.000000)">
                                                        ...
                                                        <img src="{{ asset('img/favicon/monte-logo.svg') }}"
                                                            alt="" class="pb-5">
                                                    </g>
                                                    <g id="Triangle"
                                ...
                                <span class="app-brand-text demo text-body fw-bolder">Monte Carlo</span>
                            </a>
                        </div>
                        <!-- /Logo -->
                        <h4 class="mb-2">Register to {{ $name }} ‹</h4>
                        ...
                        <form id="formAuthentication" class="mb-3" action="{{ @route('register.store') }}"
                            ...
                            <div class="mb-3 form-password-toggle">
                                <label for="passaword" class="form-label">Password</label>
